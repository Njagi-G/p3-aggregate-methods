...
# Call course_count
print(student.course_count())  

# Get the number of enrollments per day
enrollment_count_per_day = Enrollment.aggregate_enrollments_per_day()

# Print the result
print(enrollment_count_per_day)
